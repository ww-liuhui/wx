...
//当前楼盘
    ...
    var page_index = p_page_index;
    var page_size = p_page_size;
            ...
            if (lastnum == page_size) {
                ...
                if (gardenList != null && gardenList != "undefined" && gardenList.length > 0) {
                    ...
                    for (var j = 0; j < gardenList.length; j++) {
                        $("#gardenList-div ul").append('<li class="list-item section-loupan" id="' + gardenList[j].gardenId + '"><img src="' + gardenList[j].gardenImg + '"class="layout-img"><div class="right"><div class="price">' + gardenList[j].startPrice + '万起</div><div class="text-1">' + gardenList[j].gardenName + '</div><div><span class="text-2">' + gardenList[j].gardenType + '</span><span style="float: right"class="text-price">' + gardenList[j].gardenPrice + '元/平米</span></div><div class="marks"></div> </div><div class="clearfix"></div></li>');
